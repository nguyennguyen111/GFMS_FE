      ...
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">
            Tính lương theo buổi hoàn thành và chốt bảng lương theo kỳ
          </div>
        </div>
      </div>
      ...
      <div className="period-card">
        ...
        <div className="period-form">
          ...
          <input
            type="number"
            className="filter-select"
            placeholder="% hoa hồng owner (vd 15)"
                ...
                <tr key={period.id} className="period-row">
                  ...
                  <td onClick={() => handleOpenPeriod(period)}>
                    <span className={`tx-badge tx-badge-${period.status === "paid" ? "paid" : "calculated"}`}>
                      {period.status === "paid" ? "Đã chi trả" : "Đã chốt"}
                    </span>
                  </td>
                  <td>
                    {period.status !== "paid" ? (
      ...
      <div className="commissions-header">
        ...
        <div className="commissions-filters">
          ...
          >
            ...
            <option value="calculated">Đã chốt kỳ</option>
